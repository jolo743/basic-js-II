...
const result = (weather == "soleado") ? console.log("Me vestiré con un vestido") : console.log("Me vestiré con pantalón");
...
for (const programmer in programmers) {
    console.log(`${programmer}: ${programmers[programmer].name} ${programmers[programmer].lastname}, su aporte fue ${programmers[programmer].knowledge}`)
}
